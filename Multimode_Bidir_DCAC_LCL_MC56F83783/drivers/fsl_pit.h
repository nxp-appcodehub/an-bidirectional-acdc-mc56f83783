...
#define FSL_PIT_DRIVER_VERSION (MAKE_VERSION(2, 2, 1))
/*@}*/
 ...
 * @ingroup pit
 * @{
 * The current PIT driver version is 2.2.1.
 *
 * - 2.2.1
 *   - Bug Fixes
...
{
    base->CTRL = (base->CTRL & (~PIT_CTRL_PRESCALER_MASK)) | PIT_CTRL_PRESCALER(ePrescaler);
}
