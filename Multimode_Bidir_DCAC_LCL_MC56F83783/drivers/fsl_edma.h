...
#define FSL_EDMA_DRIVER_VERSION (MAKE_VERSION(2, 0, 2))
/*@}*/
 ...
 * @ingroup edma
 * @{
 * The current eDMA driver version is 2.0.2.
 *
 * - 2.0.2
...
{
    base->TCD[(uint8_t)eChannel].CITER_ELINKYES &= ~DMA_CITER_ELINKYES_LINKCH_MASK;
    base->TCD[(uint8_t)eChannel].BITER_ELINKYES &= ~DMA_CITER_ELINKYES_LINKCH_MASK;
}
...
{
    base->TCD[(uint8_t)eChannel].CSR &= ~DMA_CSR_MAJORLINKCH_MASK;
}
