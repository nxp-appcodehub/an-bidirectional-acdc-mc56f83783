...
#if 0
    OCCS->CTRL = (OCCS->CTRL & (~OCCS_CTRL_ZSRC_MASK)) | OCCS_CTRL_ZSRC(0); /* System clock switch to MSTR_OSC */
    while (OCCS_STAT_ZSRCS(0) != (OCCS->STAT & OCCS_STAT_ZSRCS_MASK))
    {
        /* Wait system switch done */
    };
    OCCS->CTRL |= OCCS_CTRL_PLLPD_MASK; /* Power down PLL */

    /* PRECS=00b to select MSTR_OSC to 8MHz(FIRC 48MHz/6) */
    OCCS->CTRL = (OCCS->CTRL & (~OCCS_CTRL_PRECS_MASK)) | OCCS_CTRL_PRECS(0);
    asm(NOP);
    asm(NOP);
    asm(NOP);
    asm(NOP);
...
Please be noted that ivINT_ADC12_CC1 can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_ADC12_CC1 definition. */
#pragma interrupt alignsp saveall
...
Please be noted that ivINT_ADC12_CC0 can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_ADC12_CC0 definition. */
#pragma interrupt alignsp saveall
...
Please be noted that ivINT_ADC12_ERR can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_ADC12_ERR definition. */
#pragma interrupt alignsp saveall
...
Please be noted that ivINT_CAN_MB_OR can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_CAN_MB_OR definition. */
#pragma interrupt alignsp saveall
...
Please be noted that ivINT_CAN_BUS_OFF can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_CAN_BUS_OFF definition. */
#pragma interrupt alignsp saveall
...
Please be noted that ivINT_CAN_ERROR can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_CAN_ERROR definition. */
#pragma interrupt alignsp saveall
...
Please be noted that ivINT_CAN_TX_WARN can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_CAN_TX_WARN definition. */
#pragma interrupt alignsp saveall
...
Please be noted that ivINT_CAN_RX_WARN can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_CAN_RX_WARN definition. */
#pragma interrupt alignsp saveall
...
Please be noted that ivINT_CAN_WAKEUP can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_CAN_WAKEUP definition. */
#pragma interrupt alignsp saveall
...
Please be noted that ivINT_eFlexPWMB_FAULT can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_eFlexPWMB_FAULT definition. */
#pragma interrupt alignsp saveall
...
Please be noted that ivINT_eFlexPWMB_RERR can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_eFlexPWMB_RERR definition. */
#pragma interrupt alignsp saveall
...
Please be noted that ivINT_eFlexPWMB_CAP can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_eFlexPWMB_CAP definition. */
#pragma interrupt alignsp saveall
...
Please be noted that ivINT_eFlexPWMB_RELOAD3 can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_eFlexPWMB_RELOAD3 definition. */
#pragma interrupt alignsp saveall
...
Please be noted that ivINT_eFlexPWMB_CMP3 can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_eFlexPWMB_CMP3 definition. */
#pragma interrupt alignsp saveall
...
Please be noted that ivINT_eFlexPWMB_RELOAD2 can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_eFlexPWMB_RELOAD2 definition. */
#pragma interrupt alignsp saveall
...
Please be noted that ivINT_eFlexPWMB_CMP2 can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_eFlexPWMB_CMP2 definition. */
#pragma interrupt alignsp saveall
...
Please be noted that ivINT_eFlexPWMB_RELOAD1 can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_eFlexPWMB_RELOAD1 definition. */
#pragma interrupt alignsp saveall
...
Please be noted that ivINT_eFlexPWMB_CMP1 can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_eFlexPWMB_CMP1 definition. */
#pragma interrupt alignsp saveall
...
Please be noted that ivINT_eFlexPWMB_RELOAD0 can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_eFlexPWMB_RELOAD0 definition. */
#pragma interrupt alignsp saveall
...
Please be noted that ivINT_eFlexPWMB_CMP0 can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_eFlexPWMB_CMP0 definition. */
#pragma interrupt alignsp saveall
...
Please be noted that ivINT_FTFE_RDCOL can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_FTFE_RDCOL definition. */
#pragma interrupt alignsp saveall
...
Please be noted that ivINT_FTFE_CC can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_FTFE_CC definition. */
#pragma interrupt alignsp saveall
...
Please be noted that ivINT_FTFE_DFD can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_FTFE_DFD definition. */
#pragma interrupt alignsp saveall
