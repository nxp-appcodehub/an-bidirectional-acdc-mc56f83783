...
- config_sets:
  ...
  - fsl_dac:
    - enableDAC: 'true'
    - dac_config:
      - referenceVoltageSource: 'DAC_8bit_VIN1'
      - DACValue: '233'
  - interrupt:
    - interrupt_sel: ''
    - enableDma: 'false'
...
static void CMPC_init(void) {
  /* Software reset the CMPC. */
  CMPC->CR0   = 0U;
  CMPC->CR1   = 0U;
  CMPC->FPR   = 0U;
  CMPC->SCR   = 0U;
  CMPC->DACCR = 0U;
  CMPC->MUXCR = 0U;
#if defined(CMPC_CR0_INIT)
  CMPC->CR0 = CMPC_CR0_INIT;
#endif /* CMPC_CR0_INIT */
#if defined(CMPC_FPR_INIT)
  CMPC->FPR = CMPC_FPR_INIT;
#endif /* CMPC_FPR_INIT */
#if defined(CMPC_SCR_INIT)
  CMPC->SCR = CMPC_SCR_INIT;
#endif /* CMPC_SCR_INIT */
#if defined(CMPC_DACCR_INIT)
  CMPC->DACCR = CMPC_DACCR_INIT;
#endif /* CMPC_DACCR_INIT */
#if defined(CMPC_MUXCR_INIT)
  CMPC->MUXCR = CMPC_MUXCR_INIT;
#endif /* CMPC_MUXCR_INIT */
#if defined(CMPC_CR1_INIT)
  CMPC->CR1 = CMPC_CR1_INIT;
#endif /* CMPC_CR1_INIT */
}
...
- config_sets:
  - fsl_pwm:
    ...
    - submodules:
      - 0:
        ...
        - config:
          ...
          - outputEn: ''
          - outputMask: ''
          - maskImmediately: 'true'
          - outputTrigger_sel: 'kPWM_ValueRegister_4'
          - triggerFrequency: '0'
          - triggerSource0: '0'
          - triggerSource1: '1'
          - interrupt_sel: 'kPWM_CompareVal5InterruptEnable'
          - interrupt_flags: 'kPWM_CompareVal5InterruptFlag'
          - dma_used: 'false'
          - dma:
        ...
        - compare_interrupt:
          ...
          - handler_custom_name: 'Fast_Ctrl_ISR'
    ...
    - capture_interrupt:
      ...
      - dsc_enable_interrrupt: 'iprVal0'
      - enable_custom_name: 'false'
    - fault_interruptEn: 'true'
    - fault_interrupt:
      - IRQn: 'keFlexPWMA_FAULT_VECTORn'
      - dsc_enable_interrrupt: 'iprVal1'
      - enable_custom_name: 'true'
      - handler_custom_name: 'CUR_CBCPro_Cnt_ISR'
...
static void CMPB_init(void) {
  /* Software reset the CMPB. */
  CMPB->CR0   = 0U;
  CMPB->CR1   = 0U;
  CMPB->FPR   = 0U;
  CMPB->SCR   = 0U;
  CMPB->DACCR = 0U;
  CMPB->MUXCR = 0U;
#if defined(CMPB_CR0_INIT)
  CMPB->CR0 = CMPB_CR0_INIT;
#endif /* CMPB_CR0_INIT */
#if defined(CMPB_FPR_INIT)
  CMPB->FPR = CMPB_FPR_INIT;
#endif /* CMPB_FPR_INIT */
#if defined(CMPB_SCR_INIT)
  CMPB->SCR = CMPB_SCR_INIT;
#endif /* CMPB_SCR_INIT */
#if defined(CMPB_DACCR_INIT)
  CMPB->DACCR = CMPB_DACCR_INIT;
#endif /* CMPB_DACCR_INIT */
#if defined(CMPB_MUXCR_INIT)
  CMPB->MUXCR = CMPB_MUXCR_INIT;
#endif /* CMPB_MUXCR_INIT */
#if defined(CMPB_CR1_INIT)
  CMPB->CR1 = CMPB_CR1_INIT;
#endif /* CMPB_CR1_INIT */
}

/***********************************************************************************************************************
 * CMPA initialization code
 **********************************************************************************************************************/
/* clang-format off */
/* TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
instance:
...
- config_sets:
  ...
  - interrupt:
    ...
    - interrupt:
      ...
      - dsc_enable_interrrupt: 'iprVal1'
      - enable_custom_name: 'true'
      - handler_custom_name: 'INV_CBC_CNT_ISR'
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS **********/
/* clang-format on */

static void CMPA_init(void) {
  /* Software reset the CMPA. */
  CMPA->CR0   = 0U;
  CMPA->CR1   = 0U;
  CMPA->FPR   = 0U;
  CMPA->SCR   = 0U;
  CMPA->DACCR = 0U;
  CMPA->MUXCR = 0U;
#if defined(CMPA_CR0_INIT)
  CMPA->CR0 = CMPA_CR0_INIT;
#endif /* CMPA_CR0_INIT */
#if defined(CMPA_FPR_INIT)
  CMPA->FPR = CMPA_FPR_INIT;
#endif /* CMPA_FPR_INIT */
#if defined(CMPA_SCR_INIT)
  CMPA->SCR = CMPA_SCR_INIT;
#endif /* CMPA_SCR_INIT */
#if defined(CMPA_DACCR_INIT)
  CMPA->DACCR = CMPA_DACCR_INIT;
#endif /* CMPA_DACCR_INIT */
#if defined(CMPA_MUXCR_INIT)
  CMPA->MUXCR = CMPA_MUXCR_INIT;
#endif /* CMPA_MUXCR_INIT */
#if defined(CMPA_CR1_INIT)
  CMPA->CR1 = CMPA_CR1_INIT;
#endif /* CMPA_CR1_INIT */
}
...
- config_sets:
  - pit_reg:
    ...
    - interrupt:
      ...
      - dsc_enable_interrrupt: 'iprVal1'
      - enable_custom_name: 'true'
      - handler_custom_name: 'PFC_VolCtrl_ISR'
    - pit_template_params: []
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS **********/
/* clang-format on */
...
- config_sets:
  - freemaster_config:
    ...
    - generalConfig:
      ...
      - canConfig:
        - peripheralCAN: 'CAN0'
        - generic_can_driver_version: '2.1.1'
...
static void BOARD_InitPeripherals_CommonPreInit(void)
{
  ...
  /* Enable clock gate of the CMPC peripheral. */
  SIM->PCE2 |= SIM_PCE2_CMPC_MASK;
  ...
  /* Enable clock gate of the CMPB peripheral. */
  SIM->PCE2 |= SIM_PCE2_CMPB_MASK;
  /* Enable clock gate of the CMPA peripheral. */
  SIM->PCE2 |= SIM_PCE2_CMPA_MASK;
...
{
  /* Set the interrupt priority: Priority 1 of the keFlexPWMA_CMP0_VECTORn request in the INTC. */
  INTC->IPR9 = (INTC->IPR9 & ~INTC_IPR9_PWMA_CMP0_MASK) | INTC_IPR9_PWMA_CMP0(2);
  /* Set the interrupt priority: Priority 0 of the keFlexPWMA_FAULT_VECTORn request in the INTC. */
  INTC->IPR8 = (INTC->IPR8 & ~INTC_IPR8_PWMA_FAULT_MASK) | INTC_IPR8_PWMA_FAULT(1);
  /* Set the interrupt priority: Priority 0 of the kPIT0_ROLLOVR_VECTORn request in the INTC. */
  INTC->IPR10 = (INTC->IPR10 & ~INTC_IPR10_PIT0_ROLLOVR_MASK) | INTC_IPR10_PIT0_ROLLOVR(1);
