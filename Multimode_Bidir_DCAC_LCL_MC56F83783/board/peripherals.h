...
/* ADC_CLIST1: SAMPLE3=4, SAMPLE2=2, SAMPLE1=3, SAMPLE0=0 */
#define ADC_CLIST1_INIT 0x4230U
/* ADC_CLIST2: SAMPLE7=7, SAMPLE6=6, SAMPLE5=5, SAMPLE4=1 */
#define ADC_CLIST2_INIT 0x7651U
/* ADC_CLIST3: SAMPLE11=11, SAMPLE10=13, SAMPLE9=12, SAMPLE8=10 */
#define ADC_CLIST3_INIT 0xBDCAU
/* ADC_CLIST4: SAMPLE15=15, SAMPLE14=14, SAMPLE13=13, SAMPLE12=8 */
#define ADC_CLIST4_INIT 0xFED8U
/* ADC_SDIS: DS=57568 */
#define ADC_SDIS_INIT 0xE0E0U
/* ADC_LOLIM0: LLMT=0 */
...
/* ADC_OFFST0: OFFSET=2048 */
#define ADC_OFFST0_INIT 0x4000U
/* ADC_OFFST1: OFFSET=2048 */
#define ADC_OFFST1_INIT 0x4000U
/* ADC_OFFST2: OFFSET=2048 */
#define ADC_OFFST2_INIT 0x4000U
/* ADC_OFFST3: OFFSET=2048 */
#define ADC_OFFST3_INIT 0x4000U
/* ADC_OFFST4: OFFSET=2048 */
#define ADC_OFFST4_INIT 0x4000U
/* ADC_OFFST5: OFFSET=0 */
...
/* CMPC_CR1: SE=0, WE=0, PMODE=0, INV=0, COS=0, OPE=0, EN=1 */
#define CMPC_CR1_INIT 0x1U
/* CMPC_FPR: FILT_PER=1 */
#define CMPC_FPR_INIT 0x1U
/* CMPC_SCR: DMAEN=0, IER=0, IEF=0 */
#define CMPC_SCR_INIT 0x0U
/* CMPC_DACCR: VOSEL=232 */
#define CMPC_DACCR_INIT 0xE8U
/* CMPC_MUXCR: DACEN=1, VRSEL=0, PSEL=7, MSEL=2 */
#define CMPC_MUXCR_INIT 0xBAU
/* Definition of peripheral ID */
...
#define Fast_Ctrl_ISR ivINT_eFlexPWMA_CMP0
/* PWMA interrupt vector ID (number). */
#define PWMA_FAULT_IRQN keFlexPWMA_FAULT_VECTORn
/* PWMA interrupt priority register (interrupt priority register/bitfield index). */
#define PWMA_FAULT_IRQ eFlexPWMA_FAULT_IRQn
/* PWMA interrupt handler identifier. */
#define CUR_CBCPro_Cnt_ISR ivINT_eFlexPWMA_FAULT
/* PWMA_SM0INIT: INIT=63036 */
#define PWMA_SM0INIT_INIT 0xF63CU
...
/* PWMA_SM0VAL1: VAL1=2499 */
#define PWMA_SM0VAL1_INIT 0x9C3U
...
/* PWMA_SM0VAL3: VAL3=0 */
#define PWMA_SM0VAL3_INIT 0x0U
/* PWMA_SM0FRACVAL4: FRACVAL4=0 */
#define PWMA_SM0FRACVAL4_INIT 0x0U
/* PWMA_SM0VAL4: VAL4=2491 */
#define PWMA_SM0VAL4_INIT 0x9BBU
/* PWMA_SM0FRACVAL5: FRACVAL5=0 */
#define PWMA_SM0FRACVAL5_INIT 0x0U
/* PWMA_SM0VAL5: VAL5=2491 */
#define PWMA_SM0VAL5_INIT 0x9BBU
...
/* PWMA_SM0STS: REF=0, RF=0, CFA1=0, CFA0=0, CFB1=0, CFB0=0, CFX1=0, CFX0=0, CMPF=32 */
#define PWMA_SM0STS_INIT 0x20U
/* PWMA_SM0INTEN: REIE=0, RIE=0, CA1IE=0, CA0IE=0, CB1IE=0, CB0IE=0, CX1IE=0, CX0IE=0, CMPIE=32 */
#define PWMA_SM0INTEN_INIT 0x20U
/* PWMA_SM0TCTRL: PWAOT0=0, PWBOT1=1, TRGFRQ=0, OUT_TRIG_EN=16 */
#define PWMA_SM0TCTRL_INIT 0x4010U
/* PWMA_SM0DISMAP0: DIS0B=7, DIS0A=7 */
#define PWMA_SM0DISMAP0_INIT 0xFF77U
/* PWMA_SM0DISMAP1: DIS1B=0, DIS1A=0 */
#define PWMA_SM0DISMAP1_INIT 0xFF00U
/* PWMA_SM0DTCNT0: DTCNT0=0 */
#define PWMA_SM0DTCNT0_INIT 0x0U
/* PWMA_SM0DTCNT1: DTCNT1=0 */
#define PWMA_SM0DTCNT1_INIT 0x0U
/* PWMA_OUTEN: PWMA_EN=0, PWMB_EN=0, PWMX_EN=0 */
#define PWMA_OUTEN_INIT 0x0U
/* PWMA_MASK: UPDATE_MASK=1, MASKA=0, MASKB=0, MASKX=0 */
#define PWMA_MASK_INIT 0x1000U
/* PWMA_SWCOUT: SM0OUT23=0, SM0OUT45=0 */
#define PWMA_SWCOUT_INIT 0x0U
/* PWMA_DTSRCSEL: SM0SEL23=0, SM0SEL45=0 */
#define PWMA_DTSRCSEL_INIT 0x0U
/* PWMA_MCTRL: IPOL=0, RUN=0, LDOK=1 */
#define PWMA_MCTRL_INIT 0x1U
/* PWMA_MCTRL2: MONPLL=0 */
#define PWMA_MCTRL2_INIT 0x0U
/* PWMA_FCTRL0: FLVL=0, FAUTO=3, FSAFE=4, FIE=3 */
#define PWMA_FCTRL0_INIT 0x343U
/* PWMA_FSTS0: FHALF=0, FFULL=7 */
#define PWMA_FSTS0_INIT 0x70U
...
/* OUTEN register mask */
#define PWMA_OUTEN_INIT_MASK 0x111U
/* MASK register mask */
#define PWMA_MASK_INIT_MASK 0x1111U
/* SWCOUT register mask */
#define PWMA_SWCOUT_INIT_MASK 0x3U
/* DTSRCSEL register mask */
#define PWMA_DTSRCSEL_INIT_MASK 0xFU
/* MCTRL register mask */
#define PWMA_MCTRL_INIT_MASK 0x1111U
...
/* CMPB_CR0: FILTER_CNT=3, HYSTCTR=0 */
#define CMPB_CR0_INIT 0x30U
/* CMPB_CR1: SE=0, WE=0, PMODE=0, INV=0, COS=0, OPE=0, EN=1 */
#define CMPB_CR1_INIT 0x1U
/* CMPB_FPR: FILT_PER=1 */
#define CMPB_FPR_INIT 0x1U
/* CMPB_SCR: DMAEN=0, IER=0, IEF=0 */
#define CMPB_SCR_INIT 0x0U
/* CMPB_DACCR: VOSEL=62 */
#define CMPB_DACCR_INIT 0x3EU
...
/* CMPA_CR1: SE=0, WE=0, PMODE=0, INV=0, COS=0, OPE=0, EN=1 */
#define CMPA_CR1_INIT 0x1U
/* CMPA_FPR: FILT_PER=1 */
#define CMPA_FPR_INIT 0x1U
/* CMPA_SCR: DMAEN=0, IER=0, IEF=0 */
#define CMPA_SCR_INIT 0x0U
/* CMPA_DACCR: VOSEL=191 */
#define CMPA_DACCR_INIT 0xBFU
...
#define PIT0_ROLLOVER_FREQ_HZ 2000U
/* PIT0_CTRL: SLAVE=0, CLKSEL=0, PRESCALER=0, PRIE=1, CNT_EN=0 */
#define PIT0_CTRL_INIT 0x2U
/* PIT0_MOD: MODULO_VALUE=49999 */
#define PIT0_MOD_INIT 0xC34FU
...
#define PFC_VolCtrl_ISR ivINT_PIT0_ROLLOVR
/* Definition of peripheral ID */
